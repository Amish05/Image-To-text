...
// import 'package:pictotxt/getPdfText.dart';

class ImageToTxt extends StatefulWidget {
  const ImageToTxt({Key? key}) : super(key: key);

  @override
  _ImageToTxtState createState() => _ImageToTxtState();
}

class _ImageToTxtState extends State<ImageToTxt> {
          ...
          children: [
            selectedImagePath != null
                ? ClipRRect(
                    ...
                    child: Image.file(
                      File(selectedImagePath!), // Convert String to File
                      fit: BoxFit.contain,
